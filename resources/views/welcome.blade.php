...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Welcome To MicromedicionIoT</title>
    ...
    <body class="antialiased">
        <div class="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-center bg-white selection:bg-red-500 selection:text-black">
            @if (Route::has('login'))
